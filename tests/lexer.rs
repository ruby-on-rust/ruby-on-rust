...
#[test]
fn integer() {
    let mut lexer = Lexer::new(String::from("42"));

    assert_eq!(lexer.advance().unwrap(), Token::T_INTEGER(42));
}
...
#[test]
fn ivar() {
    let mut lexer = Lexer::new(String::from("@blah"));

    assert_eq!(lexer.advance().unwrap(), Token::T_IVAR(String::from("@blah")));
}
