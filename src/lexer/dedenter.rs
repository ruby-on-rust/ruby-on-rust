// https://github.com/whitequark/parser/blob/fbe0e8cbec557c96b0e0f4a8c5201155ee478284/lib/parser/lexer/dedenter.rb
...
impl Dedenter {
    ...
    //   @indent_level  = 0
    // end
    pub fn new(dedent_level: isize) -> Dedenter {
        Dedenter {
            dedent_level,
            at_line_begin: true,
            indent_level: 0
    ...
    //       nil
    //     end
    pub fn dedent(&mut self, string: &String) {
        // TODO
    }
