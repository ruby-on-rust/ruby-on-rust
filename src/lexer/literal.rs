...
impl Lexer {
    ...
    pub fn push_literal(&mut self, literal: Literal) -> String {
        ...
        if literal.is_words {
            if literal.is_backslash_delimited() {
                if literal.interpolate {
                    next_state = String::from("interp_backslash_delimited_words");
                } else {
                    next_state = String::from("plain_backslash_delimited_words");
                }
            } else {
                if literal.interpolate {
                    next_state = String::from("interp_words");
                } else {
                    next_state = String::from("plain_words");
                }
            }
        } else {
            if literal.is_backslash_delimited() {
                if literal.interpolate {
                    next_state = String::from("interp_backslash_delimited");
                } else {
                    next_state = String::from("plain_backslash_delimited");
                }
            } else {
                if literal.interpolate {
                    next_state = String::from("interp_string");
                } else {
                    next_state = String::from("plain_string");
                }
            }
        }
