...
parser! {
    ...
    program: node::Node {
        top_compstmt[t] => node::Node::Dummy
    }
    ...
    //                     }
    // TODO
    top_compstmt: node::Node {
        // top_stmts[t_s] opt_terms[o_t] => {
        //     node::Node::Dummy
        // }
        => node::Node::Dummy
    }
...
pub fn parse<I: Iterator<Item=(Token, Span)>>(i: I) -> Result<node::Node, (Option<(Token, Span)>, &'static str)> {
    parse_(i)
}

// pub fn parse(lexer: Lexer) -> node::Node {
//     parse_(lexer)
// }
